...
import Toolbar from "../components/layout/flexi_mat_designer/Toolbar";
                ...
                <div className="col-md-8 col-sm-8 text-center pad0 main-content">
                  <div className="row main-edit-content">
                    <div className="addcontdiv">
                      ...
                      <p className="matsize">
                        <span>
                          MAT SIZE : {flexi_config.width}{" "}
                          {flexi_config.length_unit === "FEET" ? "ft" : "m"} x{" "}
                          {flexi_config.height}
                          {flexi_config.length_unit === "FEET" ? "ft" : "m"}
                        </span>
                      </p>
                    </div>
                  </div>
