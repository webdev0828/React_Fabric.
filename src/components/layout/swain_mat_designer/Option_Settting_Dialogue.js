...
class OptionSettingDialogue extends React.Component {
  ...
  onBuild = () => {
    ...
    if (width > 0 && height > 0) this.props.setSwainConfig(this.state)
...
const mapDispatchToProps = dispatch => {
  return bindActionCreators({ setSwainConfig }, dispatch)
}
